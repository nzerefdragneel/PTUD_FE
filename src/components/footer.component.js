      ...
      <div className="border-t mt-2 bottom-0 px-40 pb-8 pt-20 flex flex-row flex-wrap gap-2 justify-between">
        ...
        <div className="mr-2 mt-2 flex flex-row flex-wrap gap-3">
          <div className="flex flex-col items-start mr-5 gap-2">
            ...
            <div className="text-base text-neutral-600">Overview</div>
            <div className="text-base text-neutral-600">Product guides</div>
            <div className="text-base text-neutral-600">Communities</div>
            <div className="text-base text-neutral-600">FAQ</div>
          </div>
          <div className="flex flex-col items-start mr-5 gap-2">
            <div className="text-lg">About Us</div>
            <div className="text-base text-neutral-600">Company</div>
            <div className="text-base text-neutral-600">Achievements</div>
            <div className="text-base text-neutral-600">Our Goals</div>
          </div>
          <div className="flex flex-col items-start mr-5 gap-2">

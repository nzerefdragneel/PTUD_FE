    ...
    return (
        <div className="col-md-12">
            ...
            */}
                ...
                {isSubmit && !isSuccess && <div className="text-error-color text-base">{message}</div>}
                {isSubmit && isSuccess && <div className="alert alert-success text-base">Đăng ký thành công </div>}
            </div>
        </div>
    );
}

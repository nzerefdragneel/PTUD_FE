...
export default class Status_Register extends Component {
    constructor(props) {
        super(props);
    ...
    handleEdituser(e) {
        ...
        UserService.EditUser(this.state.userId, this.state.username, this.state.email, this.state.password).then(
            (response) => {

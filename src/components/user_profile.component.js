        ...
        <>
            <div class="bg-white overflow-hidden shadow rounded-lg border">
                <div class="px-4 py-3 sm:px-6">
                    <h1 class="font-semibold leading-6 text-lg text-gray-900">THÔNG TIN CƠ BẢN</h1>
                </div>
                <div class="border-t border-gray-200 px-4 py-3 sm:p-0">
                    <dl class="sm:divide-y sm:divide-gray-200">
                        ...
                        <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">example@gmaill.com</dd>
                        </div>
                        <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Số chứng minh nhân dân</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"></dd>
                        </div>
                    </dl>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg border">
                <div class="px-4 py-3 sm:px-6">
                    <h1 class="font-semibold leading-6 text-lg text-gray-900">THÔNG TIN NGHỀ NGHIỆP</h1>
                </div>
                <div class="border-t border-gray-200 px-4 py-3 sm:p-0">
                    <dl class="sm:divide-y sm:divide-gray-200">
                        <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg border">
                <div class="px-4 py-3 sm:px-6">
                    <h1 class="font-semibold leading-6 text-lg text-gray-900">THÔNG TIN NGÂN HÀNG</h1>
                </div>
                <div class="border-t border-gray-200 px-4 py-3 sm:p-0">
                    <dl class="sm:divide-y sm:divide-gray-200">
                        <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">

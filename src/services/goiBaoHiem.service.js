...
class GoiBaoHiemService {
    ...
    capNhatGBH(id, iD_GoiBaoHiem, tenBaoHiem, tenGoi, giaTien, thoiHan, moTa, ngayPhatHanh, tinhTrang, hinhAnh) {
    ...
    ThemGoiBaoHiem(iD_GoiBaoHiem, tenBaoHiem, tenGoi, giaTien, thoiHan, moTa, ngayPhatHanh, tinhTrang, hinhAnh) {
        return axios.post(
